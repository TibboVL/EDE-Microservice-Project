...
![Project diagram](/assets/EDE project.drawio.svg)
...
Prometheus is availible on the endpoint [prometheus-service-tibbovl.cloud.okteto.net](https://prometheus-service-tibbovl.cloud.okteto.net).
